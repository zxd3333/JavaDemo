...
public class PropertiesDemo {
    public static void main(String[] args) throws IOException {
        ...
        p2.setProperty("1","hello");
        p2.setProperty("2","world");

        FileWriter fw = new FileWriter("src\\com\\zxd\\basics\\look12\\StaticFile\\g.txt");
        p2.store(fw,null);
        fw.close();

        FileReader fr = new FileReader("src\\com\\zxd\\basics\\look12\\StaticFile\\g.txt");
        p2.load(fr);
        fr.close();
        ...
        FileReader fileReader = new FileReader("src\\com\\zxd\\basics\\look12\\StaticFile\\h.txt");
        p.load(fileReader);
        fr.close();
        ...
        if (i < 3){
            ...
            FileWriter fileWriter = new FileWriter("src\\com\\zxd\\basics\\look12\\StaticFile\\h.txt");
