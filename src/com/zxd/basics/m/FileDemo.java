...
public class FileDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //方式一：文件的路径创建
        File f = new File("src\\com\\zxd\\basics\\m\\a.txt");
        //方式二：父路径和文件名创建
        File f1 = new File("src\\com\\zxd\\basics\\m\\a","a.txt");
        //方式三：根据指定的父路径对象和文件路径创建
        File f3 = new File("src\\com");
        File f4 = new File(f3,"zxd\\basics\\m\\a.txt");
