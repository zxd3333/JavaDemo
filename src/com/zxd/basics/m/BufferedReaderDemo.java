...
public class BufferedReaderDemo {
    ...
    public static void main(String[] args) throws IOException {
        //写入数据
        //BufferedWriter bw = new BufferedWriter(new FileWriter("src\\com\\zxd\\basics\m\\c.txt"));
        ...
        //字符缓冲流读取数据的时候有新的方法
        BufferedReader br = new BufferedReader(new FileReader("src\\com\\zxd\\basics\\m\\c.txt"));
        String line;
        //readline() 一次读取一行数据
