...
public class ObjectStreamDemo {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        //写入数据
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("src\\com\\zxd\\basics\\m\\f.txt",true));
        ...
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("src\\com\\zxd\\basics\\m\\f.txt"));
