...
public class PropertiesDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileWriter fw = new FileWriter("src\\com\\zxd\\m\\g.txt");
        p2.store(fw,null);
        fw.close();

        FileReader fr = new FileReader("src\\com\\zxd\\m\\g.txt");
        p2.load(fr);
        fr.close();
        ...
        FileReader fileReader = new FileReader("src\\com\\zxd\\m\\h.txt");
        p.load(fileReader);
        fr.close();
        ...
        if (i < 3){
            ...
            FileWriter fileWriter = new FileWriter("src\\com\\zxd\\m\\h.txt");
